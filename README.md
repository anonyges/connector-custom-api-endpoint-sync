...
--insecure \
--data-raw '{"connector":"custom-api-endpoint-sync","version":"1.0.0","operation":"custom_api_endpoint_sync_call","params":{"api_endpoint": "custom_api_endpoint_url", "data": {"value": "1.1.1.1"}}}' | python -m json.tool
```
